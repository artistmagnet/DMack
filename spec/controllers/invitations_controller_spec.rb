...
#         invitation = Invitation.create! valid_attributes
#         put :update, {:id => invitation.to_param, :invitation => new_attributes}, valid_session
#         invitation.reload
...
#         invitation = Invitation.create! valid_attributes
#         put :update, {:id => invitation.to_param, :invitation => invalid_attributes}, valid_session
#         expect(assigns(:invitation)).to eq(invitation)
#       end
#
